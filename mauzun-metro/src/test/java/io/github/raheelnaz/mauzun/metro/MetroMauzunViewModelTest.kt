...
private class SaveableMetroViewModel : MauzunViewModel<Int, Int, Nothing>() {
    @Composable
...
private class AutomaticAssistedViewModel(
    val route: String,
) : MauzunViewModel<Nothing, String, Nothing>() {
    @Composable
...
private suspend inline fun <reified VM : MauzunViewModel<*, *, *>> Host.obtainAssisted(
    factory: MetroViewModelFactory,
    key: String? = null,
...
@Config(sdk = [34])
class MetroMauzunViewModelTest {
