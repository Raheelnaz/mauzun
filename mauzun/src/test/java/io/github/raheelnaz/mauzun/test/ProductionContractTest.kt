...
private class EchoProdViewModel : MauzunViewModel<Int, Int, Nothing>() {
    @Composable
...
private class EffectProdViewModel : MauzunViewModel<Int, Int, String>() {
    @Composable
    override fun present(events: Flow<Int>): Int {
...
private class TypedProdViewModel : MauzunViewModel<ProdEvent, Int, Nothing>() {
    @Composable
...
private class RecursiveReadViewModel : MauzunViewModel<Int, Int, Nothing>() {
    @Composable
    override fun present(events: Flow<Int>): Int {
...
private class ThrowOnFirstCompositionViewModel : MauzunViewModel<Int, Int, Nothing>() {
    var compositions = 0
...
private class CancellingHandlerProdViewModel : MauzunViewModel<Int, Int, Nothing>() {
    @Composable
    override fun present(events: Flow<Int>): Int {
        var n by remember { mutableIntStateOf(0) }
...
private class CrashOnEventProdViewModel : MauzunViewModel<Int, Int, Nothing>() {
    @Composable
    override fun present(events: Flow<Int>): Int {
...
private class ThreadRecordingViewModel : MauzunViewModel<Int, Int, Nothing>() {
...
private class EffectFloodViewModel : MauzunViewModel<Int, Int, String>() {
    @Composable
...
class ProductionContractTest {
    ...
    private fun <T : MauzunViewModel<*, *, *>> T.tracked(): T {
