...
private class CountingViewModel : MauzunViewModel<Int, Int, Nothing>() {
...
private class StormViewModel : MauzunViewModel<Int, Int, String>() {
    @Composable
    override fun present(events: Flow<Int>): Int {
...
private class DirectEffectViewModel : MauzunViewModel<Int, Int, String>() {
    @Composable
...
private class DiesOnEventViewModel : MauzunViewModel<Int, Int, Nothing>() {
    @Composable
    override fun present(events: Flow<Int>): Int {
...
private class DiesOnStartViewModel : MauzunViewModel<Int, Int, Nothing>() {
    @Composable
    override fun present(events: Flow<Int>): Int = error("dead on arrival")
}

private class StallingViewModel : MauzunViewModel<Int, Int, Nothing>() {
    @Composable
    override fun present(events: Flow<Int>): Int {
